...
همه در `index.html` (هدر و بخش تماس):

| مورد | مقدار |
| --- | --- |
| شماره تماس | `09150556871` — هدر و بخش تماس |
| واتس‌اپ | `wa.me/989150556871` |
| تلگرام | `t.me/+989150556871` |
| اینستاگرام | `instagram.com/enigsell_agency` |
| لینکدین | `linkedin.com/company/enigsell` |

دیگر placeholderی باقی نمانده است.
